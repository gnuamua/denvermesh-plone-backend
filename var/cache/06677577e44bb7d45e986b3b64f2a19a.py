# -*- coding: utf-8 -*-
__filename = '/home/gnuamua/radio/denverMesh/backend/eggs/plone.app.z3cform-4.3.2-py3.9.egg/plone/app/z3cform/templates/submit_input.pt'
...
def initialize(modules, nothing, tales, zope_version_5_9_0_):
    ...
    def render(__stream, econtext, rcontext, __i18n_domain=None, __i18n_context=None):
        ...
        try:
            ...
            # <Static value=<ast.Dict object at 0x7fa8c72edd30> name=None at 7fa8c72ed9d0> -> __attrs_140362884050752
            __attrs_140362884050752 = _static_140362872970544
            __append('\n  ')

            # <Static value=<ast.Dict object at 0x7fa8c69d05e0> name=None at 7fa8ca9e6070> -> __attrs_140362873066736
            __attrs_140362873066736 = _static_140362863412704
            __backup_bsFallback_140362873386176 = get('bsFallback', __marker)

            # <Value "python:'btn-secondary ' if not 'btn-' in view.klass else ''" (7:23)> -> __value
            __token = 190
            try:
                __zt_tmp = __attrs_140362873066736
            except get('NameError', NameError):
                __zt_tmp = None

            __value = _static_140362943564528('python', "'btn-secondary ' if not 'btn-' in view.klass else ''", econtext=econtext)(_static_140362943564240(econtext, __zt_tmp))
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863415056
            __default_140362863415056 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863412848
            __default_140362863412848 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863411648
            __default_140362863411648 = _DEFAULT_MARKER
            ...
            __attr_class = _static_140362943564528('string', 'btn ${bsFallback}${view/klass}', econtext=econtext)(_static_140362943564240(econtext, __zt_tmp))
            __attr_class = __quote(__attr_class, '"', '&quot;', None, _DEFAULT_MARKER)
            if (__attr_class is not None):
                __append((' class="%s"' % __attr_class))

            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362872974496
            __default_140362872974496 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362872971904
            __default_140362872971904 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362872973536
            __default_140362872973536 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362883922816
            __default_140362883922816 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362883198400
            __default_140362883198400 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863377136
            __default_140362863377136 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863374976
            __default_140362863374976 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863378096
            __default_140362863378096 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863377424
            __default_140362863377424 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863377376
            __default_140362863377376 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863375168
            __default_140362863375168 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863377664
            __default_140362863377664 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863378048
            __default_140362863378048 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863374784
            __default_140362863374784 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863375696
            __default_140362863375696 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863375888
            __default_140362863375888 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362863375024
            __default_140362863375024 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362873065920
            __default_140362873065920 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362873066880
            __default_140362873066880 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362873066256
            __default_140362873066256 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362873069376
            __default_140362873069376 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362873067072
            __default_140362873067072 = _DEFAULT_MARKER
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362873066208
            __default_140362873066208 = _DEFAULT_MARKER
            ...
            __attr_formnovalidate = _static_140362943564528('python', 'view.ignoreRequiredOnValidation or None', econtext=econtext)(_static_140362943564240(econtext, __zt_tmp))
            ...
            # <Symbol value=<DEFAULT> at 7fa8cb731f70> -> __default_140362872971808
            __default_140362872971808 = _DEFAULT_MARKER

            # <Value 'view/value' (9:23)> -> __cache_140362872975216
            __token = 286
            try:
                __zt_tmp = __attrs_140362873066736
            except get('NameError', NameError):
            ...
            __cache_140362872975216 = _static_140362943564528('path', 'view/value', econtext=econtext)(_static_140362943564240(econtext, __zt_tmp))

            # <BinOp left=<Value 'view/value' (9:23)> op=<class 'chameleon.nodes.Is'> right=<Symbol value=<DEFAULT> at 7fa8cb731f70> at 7fa8c72eec70> -> __condition
            __expression = __cache_140362872975216
            ...
            if __condition:
                ...
                __content = __cache_140362872975216
                __content = __quote(__content, None, '\xad', None, None)
                if (__content is not None):
                    __append(__content)
            __append('</button>')
            if (__backup_bsFallback_140362873386176 is __marker):
                del econtext['bsFallback']
            else:
                econtext['bsFallback'] = __backup_bsFallback_140362873386176
            __append('\n\n')
        except:
